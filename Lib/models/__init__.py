...
#from Lib.models.repvgg import create_RepVGG_A0

def build_model(cfg):

    if cfg.MODEL.NAME == 'sdnet18':
        from Lib.models.sdnet1 import SDNet18
        model = SDNet18(num_classes=cfg.MODEL.NUM_CLASSES, cfg=cfg)
    elif cfg.MODEL.NAME == 'sdnet18_only_first_layer':
        from Lib.models.sdnet1 import SDNet18_sdlayer_only_for_first_layer
        ...
        from Lib.models.sdnet1 import SDNet34
